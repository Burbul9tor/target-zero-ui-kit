...
<template>
  <div class="tz-table-new" :class="{ 'is-loading': loading }">
    ...
    <div ref="scroll" class="tz-table-new__scroll" tabindex="-1">
      ...
      <table class="tz-table-new__table" :class="{ 'is-stripped': stripped }">
        <colgroup>
...
.heading { display:flex;align-items:center;gap:var(--padding-spacing-4);min-width:0;height:100% }.heading>span:first-child{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.icon-button,.clear-filter,.row-action{position:relative;display:inline-grid;flex:0 0 auto;width:20px;height:20px;padding:2px;place-items:center;color:var(--icon-default);border:0;border-radius:var(--radius-xs);background:transparent;cursor:pointer}.icon-button:hover,.icon-button.active{color:var(--brand-primary);background:var(--brand-bg-active)}.filter-wrap{display:inline-flex;align-items:center;gap:2px}.icon-button b{position:absolute;top:-5px;right:-6px;min-width:14px;height:14px;padding:0 3px;color:var(--text-inverse);border-radius:var(--radius-full);background:var(--brand-primary);font:500 8px/14px var(--tz-font-family)}.clear-filter:hover,.row-action:hover{color:var(--status-error-fg);background:var(--status-error-bg)}
.selection-cell,.settings-cell,.action-cell{width:36px;min-width:36px;padding:0!important;text-align:center!important}.selection-cell .tz-checkbox,.settings-cell .icon-button,.action-cell .row-action{margin-inline:auto}.settings-cell .icon-button{color:var(--brand-primary)}.row-action{color:var(--status-error-fg)}
