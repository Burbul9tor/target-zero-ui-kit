...
.selection-cell,.settings-cell,.action-cell{width:36px;min-width:36px;padding:0!important;text-align:center!important}.selection-cell .tz-checkbox,.action-cell .row-action{margin-inline:auto}.settings-cell{overflow:hidden}.settings-cell__inner{display:grid;width:36px;height:35px;place-items:center}.settings-cell .icon-button{position:static;box-sizing:border-box;width:24px;height:24px;margin:0;padding:4px;color:var(--brand-primary);line-height:0;transform:none}.settings-cell .icon-button svg{display:block;width:16px;height:16px}.row-action{color:var(--status-error-fg)}
