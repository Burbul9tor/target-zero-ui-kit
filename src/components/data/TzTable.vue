...
.selection-cell,.settings-cell,.action-cell{width:36px;min-width:36px;padding:0!important;text-align:center!important}.selection-cell .tz-checkbox,.action-cell .row-action{margin-inline:auto}.settings-cell__inner{display:grid;width:100%;height:100%;place-items:center}.settings-cell .icon-button{position:static;margin:0;color:var(--brand-primary);transform:none}.row-action{color:var(--status-error-fg)}
